...
class AlignmentMapper:
    ...
    def __init__(self, hdp, tx_ac: str, alt_ac: str, alt_aln_method: str) -> None:
        self.tx_ac = tx_ac
        self.alt_ac = alt_ac
    ...
    def c_to_n(self, c_interval, strict_bounds: bool | None = None):
    ...
    def c_to_g(self, c_interval, strict_bounds: bool | None = None):
